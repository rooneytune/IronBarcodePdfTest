...
namespace ReadingBarcodesInCSharpTutorial
{
    public partial class Examples
    {
        ...
        public static void ReadScanPDF()
        {
            ...
            var ScanResults = BarcodeReader.ReadBarcodesFromPdf("dhltest.pdf", BarcodeEncoding.Code128 | BarcodeEncoding.ITF, BarcodeReader.BarcodeRotationCorrection.Low, BarcodeReader.BarcodeImageCorrection.MediumCleanPixels);
